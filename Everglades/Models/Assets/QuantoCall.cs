...
{
    public class QuantoCall : AQuanto
    {

        public override string getName()
        {
            return "Quanto Call on asset " + underlying.getName();
        }
        ...
        public override double getPrice(DateTime t)
        {
            ...
            Tuple<double[,], double[]> correlAndVol = AQuanto.computeCorrelationAndVol(t, underlying, underlying.getCurrency(), 20);
            ...
            wp.getPriceCallQuanto(S, Q, strike, this.getCurrency().getInterestRate(t), underlying.getCurrency().getInterestRate(t),
